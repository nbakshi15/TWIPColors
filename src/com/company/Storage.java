...
/**
 * Created by nini on 1/26/2017.
 */
public class Storage {
    //create a 2D array with all the common HTML names
    static String [] html = {"Black","Navy","DarkBlue","MediumBlue","Blue","DarkGreen","Green","Teal","DarkCyan","DeepSkyBlue",
    ...
    static String [] hexNum = {"000000" ,"000080" ,"00008B" ,"0000CD" ,"0000FF" ,"006400" ,"008000"
    ...
    public void Converter(String name){
        ...
        for(int x=0; x<html.length; x++){
            ...
            if(name.equalsIgnoreCase(html[x])){

                System.out.println("Your hex code is " + hexNum[x]);
                System.out.println("Your HTML name is " + html[x]);

            }

            String one = hexNum[x].substring(0,2);

            String two = hexNum[x].substring(2,4);

            String three = hexNum[x].substring(4,6);
